  ...
  return (
    <div style={{ background: "#fff" }}>
      ...
      <h6 className="container">
        Are you new to Neuron or to Recommendation systems? This is the place to
        start!
      </h6>
      <br />
      <ul>
      ...
      <br />
      <h6 className="container">
        Nuron follows the Django documentaion flow. A high-level overview of how
        it’s organized will help you know where to look for certain things:
      </h6>
      <br />
      <ul>
        <li className="container">
      ...
      <h6 classNameName="container font-weight-normal">
        Neuron performs unique AI tasks with in the Channel-nodes. Each channel
        nodes consists different units with API's.
      </h6>
      <br />
      <ul>
        <li className="container">
      ...
      <br />
      <h6 className="container font-weight-normal">
        The threat node which directly link with the user applications. Based on
        the domain and service the user provides, the input and output of the
        API models will vary.
      </h6>
      <br />
      <ul>
        <li className="container">
      ...
      <br />
      <h6 className="container font-weight-normal">
        The Request and Response are controlable with in your accound dashboard.
      </h6>
      <br />
      <hr />
      <br />
      ...
      <h6 className="container font-weight-normal">
        ...
        <ul>
          <li className="container">
            In Neuron terminology the request and response structures are called
            as models. each APIs requires unique models to perform.{" "}
          </li>
          <br />
          <li className="container">
            <span className="text-danger">
